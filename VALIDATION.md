...
- `python3 -B -m unittest discover -s tests`: **74 tests passed, none skipped** (81.2 s, local run before commit). The named `full-suite` check was run through the role CLI after committing; see the task result for its run ID.
